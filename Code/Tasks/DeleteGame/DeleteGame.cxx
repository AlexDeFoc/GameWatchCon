...
auto tasks::DeleteGame(core::Console& console, core::GameLibrary& game_library) noexcept -> core::TaskType {
    ...
    if (console.GetUserConfirmationStatus() == true) {
        ...
        console.WriteLineToCache(core::Console::MsgType::Info, "Deleted game");
    } else {
        console.WriteLineToCache(core::Console::MsgType::Info, "Action cancelled");
    }

...
module Task_ValidateGameTitleUsedToChangeGameTitle;
...
ValidateGameTitleUsedToChangeGameTitle::ValidateGameTitleUsedToChangeGameTitle(const std::shared_ptr<Context>& ctx) noexcept : Task{ctx}, console_{Task::ctx->console} {}

auto ValidateGameTitleUsedToChangeGameTitle::Run() noexcept -> std::unique_ptr<Task> {

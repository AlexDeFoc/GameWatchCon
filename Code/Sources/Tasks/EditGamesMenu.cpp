...
auto gw::tasks::EditGamesMenu(gw::Console& console, gw::AppState&, gw::AppSettings&, gw::GameLibrary& game_library) -> void* {
    ...
    switch (opt_sel) {
        ...
        case 1:
            return (void*)gw::tasks::ChangeGameTitle;

        case 2:
            return (void*)gw::tasks::ResetGamePlaytime;

        case 3:
            return (void*)gw::tasks::DeleteGame;

...
auto gw::AppSettings::GetAutoSaveInterval() const noexcept -> std::chrono::seconds {
    return std::chrono::seconds(disk_manager_.GetAutoSaveIntervalValue());
}
...
auto gw::AppSettings::SetAutoSaveInterval(std::chrono::seconds new_interval) const noexcept -> void {
